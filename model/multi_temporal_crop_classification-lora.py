...
def evaluate_model(model, data_loader):
    ...
    average_time = total_time / len(data_loader)
    return average_time

def log_results(filename, fieldnames, data):
...
# fiq: é
lora_params = dict(
    rank=8,  # Rank of the tensor decomposition
    adapter_size=768 # Size of the adapter layer
)

# model
# TO BE DEFINED BY USER: model path
# pretrained_weights_path = "workspace/hls-foundation-os/Prithvi-100M/Prithvi_100M.pt"
pretrained_weights_path = "Prithvi-100M/Prithvi_100M.pt"
num_layers = 6
patch_size = 16
embed_dim = 768
num_heads = 8
...
experiment = "trial"
project_dir = "workspace/hls-foundation-os"
...
# data_root = "workspace/hls-foundation-os/data/multi-temporal-crop-classification"
...
model = dict(
    ...
    backbone=dict(
        ...
        mlp_ratio=4.0,
        norm_pix_loss=False,
        lora_config=lora_params  # Include LoRA configuration here
    ),
    neck=dict(
